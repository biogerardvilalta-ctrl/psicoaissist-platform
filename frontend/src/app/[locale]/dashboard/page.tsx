...
export default function DashboardPage() {
  ...
  const renderItem = (id: string) => {
    ...
    switch (id) {
      ...
      case 'monthIncome': return <StatsWidget id={id} data={{ title: t('Stats.income'), value: `${advancedStats.monthIncome}€`, icon: Euro, iconBgColor: "bg-emerald-100", iconColor: "text-emerald-700", subtitle: t('Stats.subtitles.thisMonth'), trend: { value: user?.hourlyRate ? `${user.hourlyRate}€/h` : '', isPositive: true }, onClick: () => handleCardClick(id) }} />;
