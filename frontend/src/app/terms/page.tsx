          ...
          <div className="prose max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                Al acceder y utilizar PsycoAI, usted acepta estar sujeto a estos Términos y Condiciones. 
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                PsycoAI es una plataforma de software como servicio (SaaS) que proporciona:
              </p>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">Puede usar PsycoAI únicamente para:</p>
              <ul className="list-disc pl-6 text-gray-700 mb-4">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                ...
                antes de usar PsycoAI para procesar sus datos.
              </p>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                PsycoAI y todo el software, contenido y materiales relacionados son propiedad 
            ...
            <section className="mb-8">
              ...
              <div className="bg-gray-100 p-4 rounded-lg">
                <p className="text-gray-800 font-medium">PsycoAI Legal</p>
                <p className="text-gray-700">Email: legal@psycoai.com</p>
