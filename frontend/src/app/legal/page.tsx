        ...
        <div className="min-h-screen flex flex-col bg-gray-50">
            ...
            <main className="flex-grow container mx-auto py-12 px-4 sm:px-6 lg:px-8 max-w-7xl">
                <div className="flex items-center justify-between mb-8">
                    <h1 className="text-3xl font-bold text-gray-900">Centro Legal</h1>
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                        <TabsList className="grid w-full grid-cols-2 md:grid-cols-4 max-w-3xl mx-auto mb-8 h-auto p-1">
                            <TabsTrigger value="gdpr" className="gap-2 py-3">
                                <Lock className="h-4 w-4" />
                                <span className="hidden sm:inline">Pol. Privacidad</span>
                            ...
                            <TabsTrigger value="legal-justification" className="gap-2 py-3">
                                ...
                                <span className="hidden sm:inline">Justificación IA</span>
                                <span className="sm:hidden">Legal IA</span>
                            </TabsTrigger>
                        </TabsList>
                ...
                <div className="text-center text-sm text-gray-500 pt-12 pb-4">
                    <p>Documento informativo generado por PsicoAIssist Platform • Cumplimiento Normativo 2024-2025</p>
                </div>
            </main>
        </div>
    );
